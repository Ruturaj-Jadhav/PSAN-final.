...
from .models import Category, Contactuss, Post
from theblog.models import Post,Contactus,Contactuss
...
def softwareengg(request):
    return render(request, 'softwareengg.html')     
...
def contactuss(request):
    if request.method=="POST" :
        ...
        contactuss=Contactuss(name=name,email=email,phone=phone,message=message)
        contactuss.save()
